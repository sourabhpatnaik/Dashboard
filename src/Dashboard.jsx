...
const Dashboard = () => {
   ...
   useEffect(() => {
    ...
    return (
    <div class="col main pt-5 mt-0" style={{backgroundColor:"#F67B50"}}>
         

        <p class="lead d-none d-sm-block text-center"><strong style={{color
        :"#fff"}}>Add Patient's Details and Records</strong></p>
        ...
        <div class="alert alert-warning fade collapse" role="alert" id="myAlert">
            ...
            <strong>Data and Records</strong> Learn more about Patient
        </div>
        <div class="row mb-3">
            ...
            <div class="col-xl-3 col-sm-6 py-2">
                <div class="card text-white bg-danger h-100">
                    <div class="card-body bg-danger">
                        ...
                        <h6 class="text-uppercase" >Previous Records</h6>
            ...
            <div class="col-xl-3 col-sm-6 py-2">
                <div class="card text-white bg-info h-100">
                    <div class="card-body bg-info">
                        ...
                        <h6 class="text-uppercase">Medications</h6>
        ...
        <div class="row ">
            <div class="col-lg-30 col-md-20 col-sm-12 text-center" >
              <h5 class="mt-3 mb-3 text-secondary" >
               <span style={{color:"#fff"}}>Previous Record of Patient
              </span>
               </h5>
                    ...
                    <table class="table table-striped">
                        ...
                        <tbody>
                           ...
                           <tr  style={{backgroundColor:"#fff"}}>
                            ...
                            <td>Mr. Gulati</td>
                            <td>22-2-2023</td>
                            <td>Fever , Weakness , Cold , chills , shievering</td>
                            <td>Paracetamol , chloroquine</td>
                           </tr>

                           <tr  style={{backgroundColor:"#C5C5C5"}}>
                            <td>2.</td>
                            <td>Mr.Komal chand</td>
                            <td>26-2-2022</td>
                            <td> Weakness , Cold , chills , shievering</td>
                            <td>Paracetamol , Citazine</td>
                           </tr>
                           ...
                           <tr  style={{backgroundColor:"#fff"}}>
                            ...
                            <td>Mr.RamLal</td>
                            <td>2-10-2022</td>
                            <td>Blurred vision , Eye pain</td>
                            <td>Relief Eye Drops</td>
                           </tr>
                           ...
                           <tr  style={{backgroundColor:"#C5C5C5"}}>
                            ...
                            <td>Mr.Khare</td>
                            <td>03-5-2021</td>
                            <td>Upset stomach , Stomach pain , Burning Chest</td>
                            <td>Sporlaic , Interquinol</td>
                           </tr>
                           ...
                           <tr  style={{backgroundColor:"#fff"}}>
                            ...
                            <td>Mr.Tiwari</td>
                            <td>22-2-2021</td>
                            <td>Skin redness , small spots</td>
                            <td>clovezine cream , Zodern cream</td>
                           </tr>
